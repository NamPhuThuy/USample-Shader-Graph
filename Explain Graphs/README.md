...
<img src="img.png" alt="A description of the image" width="400">
...
- Với multiFactor = 1:
  ...
  <img src="multiply_01.png" alt="A description of the image" width="450">
- Với multiFactor = 10:
  - u * multiFactor = 0 -> 10 
  - v * multiFactor = 0 -> 10
  ...
  <img src="multiply_02.png" alt="A description of the image" width="450">
- Với multiFactor = 50:
  - u * multiFactor = 0 -> 50
  - v * multiFactor= 0 -> 50
  - Lúc này, hầu hết mesh đều hiện màu vàng (1, 1), chỉ có phần rất nhỏ ở góc thể hiện vùng gradient  
  <img src="multiply_03.png" alt="A description of the image" width="450">
- Với multiFactor = 100:
  - u * multiFactor = 0 -> 100
  - v * multiFactor = 0 -> 100
  - Lúc này, gần như ta sẽ chỉ nhìn thấy một màu vàng trơn  
  <img src="multiply_04.png" alt="A description of the image" width="450">
...
- Với multiFactor = 1:
  ...
  <img src="fraction_01.png" alt="A description of the image" width="450">
- Với multiFactor = 2:
  - u * multiFactor = 0 -> 2 
  - v * multiFactor = 0 -> 2
  - Lúc này:
    ...
    <img src="fraction_02.png" alt="A description of the image" width="450">
